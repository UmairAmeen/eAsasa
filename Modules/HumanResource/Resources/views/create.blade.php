        ...
        <div class="m-portlet">
            <div class="panel">
                <div class="panel-body wizard-content">
                    <form id="formCreateEmployee" action="{{url('/hr/store')}}" method="POST" enctype="multipart/form-data"
                          action="#" class="tab-wizard wizard-circle wizard clearfix" id="m_form">
                                ...
                                <div class="col-xl-8 offset-xl-2">
                                    <div class="m-form__section m-form__section--first">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="date_of_joining" class="form-control m-input"
                                                       readonly placeholder="Select date" id="m_datepicker_2"/>
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <textarea class="form-control" rows="4" placeholder="Comments"
                                                          name="description" style="width: 100%"></textarea>
                                                <span class="m-form__help"></span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="tel" name="cnic" data-mask="99999-9999999-9"
                                                   {{-- pattern="^\d{5}-\d{7}-\d{1}$" --}} class="form-control m-input"
                                                   placeholder="XXXXX-XXXXXXX-X" value="">
                                            {{--<span class="m-form__help"></span>--}}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="col-xl-9 col-lg-9 m-radio-inline">
                                                <select class="form-control" name="billing_type">
                                                    <option value="per_day" {{is_selected(settings('hr_billing_type'), "per_day")}}>
                                                        Per Day
                                                    </option>
                                                    <option value="per_hour" {{is_selected(settings('hr_billing_type'), "per_hour")}}>
                                                        Per Hour
                                                    </option>
                                                    <option value="no_deduction" {{is_selected(settings('hr_billing_type'), "no_deduction")}}>
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-xs-6">
                                            <input class="form-control" name="start_time" id="m_timepicker_1"
                                            ...
                                            <div class="tab-content  m--padding-30">
                                                <div class="m-form__section m-form__section--first">
                                                    ...
                                                    <div id="first_tab">
                                                        ...
                                                        <div class="form-group m-form__group m-form__group--sm row">
                                                            ...
                                                            <div class="col-xl-8 col-lg-8">
                                                                <span class="m-form__control-static">abc</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Father Name</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">Abc</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        ...
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">03324558524</span>
                                                        </div>
                                                    </div> 
                                                </div>
                                                <div class="m-separator m-separator--dashed m-separator--lg"></div>
                                                    <div class="m-form__section">
                                                    <div class="m-form__heading">
                                                        <h3 class="m-form__heading-title">Mailing Address</h3>
                                                    </div>
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Address:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">faisal town</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Description:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">Nothing to display</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>      
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse">
                                        ...
                                        <div class="tab-content  m--padding-30">
                                            <div class="m-form__section m-form__section--first">
                                                    <div class="m-form__heading">
                                                        <h3 class="m-form__heading-title">Legal Details</h3>
                                                    </div>
                                                    <div id="second_tab"></div>
                                                     <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">CNIC:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">3210288346217</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Profile Pic:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">pic here</span>
                                                        </div>
                                                    </div> 
                                                 ...
                                                 <div class="m-form__section">
                                                    ...
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Employe Type:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">Salary</span>
                                                        </div>
                                                    </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse ">
                                        ...
                                        <div class="tab-content  m--padding-30">
                                                <div class="m-form__section m-form__section--first">
                                                    <div class="m-form__heading">
                                                        <h3 class="m-form__heading-title">Employment Settings</h3>
                                                    </div>
                                                    <div id="third_tab"></div>
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Salary:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">00000</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Start Time:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">00:00</span>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">End Time:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">00:00</span>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                        <label class="col-xl-4 col-lg-4 col-form-label">Working Day:</label>
                                                        <div class="col-xl-8 col-lg-8">
                                                            <span class="m-form__control-static">Monday</span>
                                                        </div>
                                                    </div> 
                                                </div>
                                            </div>      
                                    ...
                                    <div class="col-xl-12">
                                        <div class="m-checkbox-inline">
                                            <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                                ...
                                                Click here to indicate that you have put all information according to your best knowledge
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#m_timepicker_1, #m_timepicker_2").datetimepicker({pickDate: true, minuteStep: 5, format: 'hh:ii:ss', autoclose: true, showMeridian: false, startView: 1, maxView: 1,});
            ...
            $('#m_datepicker_2, #m_datepicker_2_validate').datepicker(
                {
                    ...
                    templates: {leftArrow: '<i class="fa fa-angle-left"></i>', rightArrow: '<i class="fa fa-angle-right"></i>'}});
