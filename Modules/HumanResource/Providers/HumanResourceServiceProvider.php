...
class HumanResourceServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('humanresource.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'humanresource'
        );
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'humanresource');
        }
    }
