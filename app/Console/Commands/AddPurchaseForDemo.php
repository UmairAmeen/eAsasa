...
class AddPurchaseForDemo extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fake:purchase {count}';
    ...
    public function handle()
    {
        ...
        for ($ix=0; $ix < $count; $ix++) { 
            ...
            $invoice->supplier_id = Supplier::all()->random()->id;
            ...
            foreach ($product_ids as $key => $value) {
                ...
                supplier_price_record($invoice->date, $saleprice[$key], $invoice->supplier_id, $product_ids[$key]);
                ...
                if (strcasecmp($stype[$key] ,"damage") != 0)
                {
                    ...
                    $sale->type = $sp_type;
                    $sale->supplier_id = $invoice->supplier_id;
...
// \Log::info("T".$worth);
            ...
            $transaction->supplier_id = $invoice->supplier_id;
