...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Update Sale </h1>
...
@section('content')
    @include('error')
          <form id="product_add_form" method="post" action="{{ route('sales.update',$sale_order->id) }}" >
               ...
               <div class="col-md-12" style="    background-color: cornsilk;">
                   <div class="col-md-3">
                       <div class="form-group" id="date_form_group">
                            <label>Date:</label>
                            <input type="date" name="date" value="{{$sale_order->date}}" class="form-control" required="required">
...
<hr>
                  ...
                  <div class="form-group">
                    <p>
                      ...
                      <strong>Total Items: <span id="item_count">{{count($sale_order->orders)}}</span></strong>
                            ...
                            <label>Notes:</label>
                           <textarea name="description" class="form-control">{{$sale_order->description}}</textarea>
                  </div>
          ...
          <center>
            {!! get_invoice_submit_buttons("Sale", 'Update') !!}
            </center>
        </div>
        </div>
    </form>
