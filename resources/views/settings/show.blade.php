...
<div class="page-header">
        <h1>Settings / Show #{{$setting->id}}</h1>
        <form action="{{ route('settings.destroy', $setting->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('settings.edit', $setting->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
