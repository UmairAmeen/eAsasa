...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Add Customer </h1>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-md-10">
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="form-group">
                    <label>CNIC:</label>
                    <input type="number" name="cnic" class="form-control" placeholder="Customer CNIC">
                    {{-- <small id="emailHelp" class="form-text text-muted">This is required</small> --}}
                </div>
                <div class="form-group">
                    <label>NTN:</label>
                    <input type="text" name="ntn" class="form-control" placeholder="Customer NTN">
                    {{-- <small id="emailHelp" class="form-text text-muted">This is required</small> --}}
                </div>
                <div class="form-group">
                    <label>Phone:</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="registeration_number"
                ...
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-muted">When you last reminded for payment or last paid,
                        notification will base on this</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-muted">After How Many Days, did it remaind for
                        Payment</small>
                </div>
                <div class="form-group">
                    <label>Notes</label>
                ...
                <div class="well well-sm">
                    ...
                    <a class="btn btn-link pull-right" href="{{ route('customers.index') }}"><i
