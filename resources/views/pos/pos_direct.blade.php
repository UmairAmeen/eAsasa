...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
            <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6" id="payment_details">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td colspan="2"> <input id="bill_number" class="form-control"
                                                name="bill_number" placeholder="Bill Number (if any)"> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> <input id="amount_paid" onkeyup="difference_calculator()"
                                                class="form-control" name="payment" placeholder="Amount Paid"> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> <input id="amount_paid_2" onkeyup="difference_calculator()"
                                                class="form-control" value="0" name="payment_creditcard"
                                                placeholder="Amount Paid"> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2"> <input id="remaining" class="form-control" value="0"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <textarea class="form-control" id="description" placeholder="Invoice Note/description"></textarea>
                                        </td>
                                    </tr>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="complete_sale('sm')">Complete Sale &amp;
                        Print Small</button>
                    <button type="button" class="btn btn-primary" onclick="complete_sale('lg')">Complete Sale &amp;
                        Print Lg</button>
                    <button type="button" class="btn btn-primary" onclick="complete_sale('')">Complete Sale &amp;
                        Close</button>
                </div>
            </div>
        </div>
    ...
    <section class="section-content padding-y-sm bg-default ">
                ...
                <div class="col-md-6 row top-bg-left">
                    ...
                    <div class="brand-wrap">
                        <h2 class="logo-text pos-text"> &nbsp; POINT OF SALE - POS
                            <a href="{{ url('/') }}"> <i class="fa fa-home backhomeico" title="Back to Dashboard">
                                </i> </a>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="barcode" name="barcode_search" id="barcode_search"
                        ...
                        <div class="inputsearch_area">
                            <div class="input-group mb-3 searcharea" style="display:none;margin-top:5px">
                                <input type="text" accesskey="a" id="search" name="search" placeholder="FIND... [ALT+W]"
                                    autocomplete="off" class="form-control searchrelated_input" onkeyup="search(this)">
                                <div class="input-group-append">
                                    <a href="javascript:void(0)" onclick="updateProducts()"
                                        class="btn btn-default relatedproduct_btn"> <i class="fa fa-redo-alt"></i>
                                        &nbsp; Reload Products</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 row">
                    ...
                    <div class="col-md-6 padding-y-sm card pos_leftcard">
                        ...
                        <div class="row topleft_heading" id="catalog_heading">
                            <center>
                                <h3 id="selectproceeding" class="pos-text-mid">Select Customer before Proceeding</h3>
                            </center>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12 rightsec_saletop">
                                        <div class="btn-group" style="width:100%">
                                            <a data-type="sale" style="width:50%"
                                                class="btn btn-default salesbtn pos_type"
                                                href="{{ url('pos/direct') }}"> SALE </a>
                                            <a href="{{ url('pos') }}" style="width:50%" type="button"
                                                class="btn btn-default salesbtn" data-type="sale_order"> SALE ORDER /
                                                QUOTATION </a>
	 ...
	 <div class="col-12 rightsec_sale"  >
		 <label>Date</label>
		 <input type="date" class="saledate" name="date" id="date" value="{{date('Y-m-d')}}">	
	...
	<br>
		 ...
		 <small class="text-muted">ALT+C</small>
                                        ...
                                        <select id="warehouse_id" name="warehouse_id" class="form-control">
                                            @foreach ($warehouses as $customer)
                            ...
                            <div class="orderarea" style="display:none">
                                <center> <img class="add_item_img"
                                        src="{{ asset('assets/img/add-item-icon.png') }}"> </center>
                            ...
                            <div class="box">
                                <div class="pos_table">
                                    <table class="table">
                                        <tr>
                                            <td> Discount </td>
                                            <td> <input type="number" onkeyup="updateTotals()" class="form-control"
                                                    min="0" step="0.01" id="discount" name="discount" value="0.00">
                                            </td>
                                            <td> Sub Total </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%"> <input type="number" onkeyup="updateTotals()"
                                                    class="form-control" min="0" step="0.01" id="shipping"
                                                    name="shipping" value="0.00"> </td>
                                            <td> Grand Total </td>
                                            <td width="30%">
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <a href="javascript:void(0)" onclick="finishSale()">
                                                    <div class="bottomicons printbtn"> <i class="fa fa-print"> </i>
                                                        <p class="p-print"> Print </p>
                                                    </div>
                                                </a>
                                                <a href="javascript:void(0)">
                                                    <div class="bottomicons"> <i class="fa fa-bell-slash "> </i>
                                                        <p class="no-sale"> No Sale </p>
                                                    </div>
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td> <a href="{{ url('pos') }}"
                                                    class="btn btn-default btn-error btn-lg btn-block btn_sale_cancel"><i
                                                        class="fa fa-times-circle "></i> Cancel </a> </td>
                                            <td colspan="2"> <a href="javascript:void(0)" onclick="finishSale()"
                                                    class="btn btn-lg btn-block btn_sale_complete"><i
                                                        class="fa fa-shopping-bag"> </i> Complete <br> <small> shift+s
                                                    </small> </a> </td>
                                            <td> <a href="javascript:void(0)" onclick="finishSale()"
                                                    class="btn btn-default btn-error btn-lg btn-block btn_payment"><i
                                                        class="fa fa-check"></i> Pay </a> </td>
                                        </tr>
    ...
    <form id="my_form" action="{{ route('sales.store') }}">
        <!-- combine all -->
    </form>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $(window).bind('keydown', 'alt+w', function() {
                $("#search").select();
            ...
            $(window).bind('keydown', 'alt+i', function() {
                $("#date").select();
                $(".selected").removeClass("selected");
            });
        ...
        function renderProducts(count = 24, current_page = 1, search = "") {
            ...
            $(products_json_d).each(function(index, element) {
                ...
                if ((element.name && element.name.toLowerCase().indexOf(search) > -1) || (element.brand && element
                        .brand.toLowerCase().indexOf(search) > -1) || (element.urdu && element.urdu.toLowerCase()
                        .indexOf(search) > -1) || (element.barcode && element.barcode.toLowerCase().indexOf(
                        search) > -1) || mix_tea.toLowerCase().indexOf(search) > -1) {
                    ...
                    if (unlocked && ++cc <= count) {
                        ...
                        if (element.stock <= element.notify) {
                            var notifystock = '<span class="badge redcircle"> ' + parseInt(element.stock) +
                                ' </span>';
                        } else {
                            var notifystock = '<span class="badge greencircle"> ' + parseInt(element.stock) +
                                ' </span>';
                        }
                ...
                if (total_pages > 1) {
                    ...
                    if (current_page > 1) {
                        template += '<li class="page-item">\
        			    			      <a href="javascript:void(0)" class="page-link" onclick="renderProducts(' + count + ', ' + (
                            current_page - 1) + ',\'' + search + ' \' )" tabindex="-1">Previous</a>\
        			    			    </li>';
                    } else {
                    ...
                    for (i = 1; i < total_pages; i++) {
                        if (i > current_page - 4 && i < current_page + 5) {
                            ...
                            template += '<a href="javascript:void(0)" class="page-link" onclick="renderProducts(' + count +
                                ', ' + i + ',\'' + search + ' \')" >' + i + '</a></li>';
                            my_round = i;
                        }
                    ...
                    template += '<a X="Y" href="javascript:void(0)" class="page-link" onclick="renderProducts(' + count +
                        ', ' + total_pages + ',\'' + search + ' \')" >' + total_pages + '</a></li>';


                    if (total_pages > current_page) {
                        template += '<li class="page-item">\
        			    			      <a href="javascript:void(0)" class="page-link" onclick="renderProducts(' + count + ', ' + (
                            current_page + 1) + ',\'' + search + ' \')"  tabindex="-1">Next</a>\
        			    			    </li>';
                    } else {
                        template += '<li class="page-item disabled">\
        ...
        function syncCart(id, type, value) {
            ...
            if (added == false && type == "add") {
                value.quantity = 1;
                value.warehouse = $("#warehouse_id option:selected").text();
                value.warehouse_id = $("#warehouse_id").val();
            ...
            $(cart).each(function(index, element) {
                ...
                cart_content += '\
        			<tr>\
        				...
        				<td class="text-right"> \
        				<h6>' + element.warehouse + '</h6>\
        				</td>\
        				<td class="text-center"> \
        					<div class="m-btn-group m-btn-group--pill btn-group mr-2" role="group" aria-label="...">\
        																				\
        					<input class="form-control" type="text" onchange="syncCart(' + element.id +
                    ',\'quantity\',this)" name="quantity[]" min="1" step="1" value="' + element.quantity + '">\
        																				</div>\
        				</td>\
        				<td> \
        					<div class="price-wrap"> \
        						<var class="price"><input type="text" class="form-control" style="width:150px"  onfocusout="syncCart(' +
                    element
                    .id + ',\'price\',this)"  name="price[]" value="' + element.price + '"></var> \
        					</div> <!-- price-wrap .// -->\
        				</td>\
        				<td class="text-right"> \
        				<h6>' + element.total + '</h6>\
        ...
        function finishSale() {
            ...
            ft += "<tr>\
        		<td colspan='4'>Packing and Shipping</td>\
        		<td colspan='2'>" + shipping + "</td>\
        		</tr>"

            ft += "<tr>\
        		<td colspan='4'><h4 class='modal-h4'>Grand Total</h4></td>\
        ...
        function complete_sale(print_type = "sm") {
            ...
            $(cart).each(function(index, element) {
                ht += '<input type="hidden" name="product[]" value="' + element.id + '">\
                			...
                			<input type="hidden" name="warehouse[]" value="' + element.warehouse_id + '">\
