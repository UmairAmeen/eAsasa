...
<div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Complete Purchase</h5>
      		...
      		<div class="row">
      			...
      			<div class="col-6" id="payment_details">
      				...
      				<div class="form-group">
      					...
      					<input id="bill_number" class="form-control" name="bill_number" placeholder="Bill Number (if any)">
      				</div>
      				...
      				<div class="form-group">
      					<label>Amount</label>
      					<input id="amount_paid" onkeyup="difference_calculator()" class="form-control" name="payment" placeholder="Amount Paid">
      				</div>
      				<div class="form-group">
      					<label>Amount Remaining</label>
      					<input id="remaining" class="form-control" value="0" readonly="readonly">
      				</div>
      				<!-- <div class="form-group">
      					<label>Transaction Ref</label>
      					<input class="form-control" name="ref" placeholder="Amount Reference">
      				</div> -->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="complete_sale('sm')">Complete Purchase &amp; Print Small</button>
        <button type="button" class="btn btn-primary" onclick="complete_sale('lg')">Complete Purchase &amp; Print Lg</button>
        <button type="button" class="btn btn-primary" onclick="complete_sale('')">Complete Purchase &amp; Close</button>
      </div>
    </div>
  </div>
</div>
...
<section class="section-content padding-y-sm bg-default ">
	...
	<div class="col-md-6 padding-y-sm card pos_leftcard">
		...
		<div class="row topleft_heading" id="catalog_heading" >
			<center><h3 class="pos-text-mid">Select Supplier before Proceeding</h3></center>
		</div>
	...
	<div class="row">
	 <div class="col-12 rightsec_saletop">
		 <div class="btn-group" style="width:100%">
			 <a data-type="sale" class="btn btn-default salesbtn pos_type" href="{{url('pos/direct')}}"> SALE </a>
			 <a href="{{url('pos')}}" type="button" class="btn btn-default salesbtn" data-type="sale_order"> SALE ORDER / QUOTATION </a>
			 {{-- <a href="#" type="button" class="btn btn-default salesbtn" data-type="quotation"> QUOTATION </a> --}}
...
<form id="my_form" action="{{ route('purchases.store') }}">
	<!-- combine all -->
</form>
...
<script type="text/javascript">
	...
	{
		$("#remaining").val(  $("#amount_paid").data('cart') - $("#amount_paid").val()  );
	}
