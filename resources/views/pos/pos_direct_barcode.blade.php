...
<div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="complete_sale('sm')">Complete Sale &amp; Print Small</button>
        <button type="button" class="btn btn-primary" onclick="complete_sale('lg')">Complete Sale &amp; Print Lg</button>
        <button type="button" class="btn btn-primary" onclick="complete_sale('')">Complete Sale &amp; Close</button>
      </div>
    </div>
  </div>
</div>
...
<section class="section-content padding-y-sm bg-default ">
	...
	<div class="row">
        ...
        <div class="col-md-12 row top-bar-black">
           
                <div class="col-md-3 col-sm-6">
                    <h3 class="h3-top"> Point of Sale </h3>
                    <small class="small-white"> Powered By </small>
                </div>

                <div class="col-md-4  col-sm-6">
                    <h3 class="company-title"> Aspire Analytica </h3>
                </div>

                <div class="col-md-5">
					<a href="{{ url('/') }}"> <i class="fa fa-home backhomeico" title="Back to Dashboard"> </i> </a>
					<a href="{{ url('/') }}"> <i class="fa fa-question-circle backhomeico" title="Help"> </i> </a>
                </div>
            
        </div>

        <div class="col-md-12 row top-bar-grey">
			...
			<div class="col-md-5 col-sm-6">
				...
				<small class="text-muted"> Select Customer before Proceeding </small>
			</div>
		...
		<div class="col-md-12 row top-bar-grey">
			<div class="col-md-4">
				<input type="text" class="form-control" name="barcode_search" id="barcode_search" placeholder="Barcode Scanning..." >
			</div>

			<div class="col-md-4">
				
					<div class="input-group mb-3 searcharea">
						<input type="text" accesskey="a" id="search" name="search" placeholder="FIND... [ALT+W]" autocomplete="off" class="form-control searchrelated_input" onchange="search(this)">
			...
			<div class="col-md-4">
				<ul class="nav nav-pills navbtn">
					<li class="nav-item">
						<a class="nav-link" data-toggle="pill" href="#discounttab" role="tab" aria-controls="pills-discount" aria-selected="false"> Discount </a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="pill" href="#shippingtab" role="tab" aria-controls="pills-shipping" aria-selected="false"> Shipping & Packing</a>
					</li>
				</ul>      
			</div>
		</div>
		...
		<div class="col-md-12 row top-bar-grey">
			...
			<div class="col-md-6 col-lg-6">
				<div class="tab-content">
					<div class="tab-pane fade show" id="discounttab" role="tabpanel" aria-labelledby="pills-discount">
						<label> Discount </label>
						<input type="number" onkeyup="updateTotals()" class="form-control" min="0" step="0.01" id="discount" name="discount" value="0.00">
					</div>
					<div class="tab-pane fade" id="shippingtab" role="tabpanel" aria-labelledby="pills-shipping">
						<label> Shipping & Packing </label>
				...
				<table class="table table-striped table-hover">
					<thead class="thead-black">
						<tr>
							...
							<th scope="col" width="120"> Qty / Wt </th>
							<th scope="col" width="120"> Price </th>
							<th scope="col" width="320"> Net Amount </th>
						</tr>
					</thead>
					...
					<tfoot class="tfoot-black">
						<tr>
							<th colspan="4"> </th>
							<th class="th-grey"> Total Items </th>
							<th class="th-grey"> Total Qty / Wt </th>
							<th class="th-grey"> Gross Amount </th>
							<th class="th-grey"> Net Amount </th>
						</tr>

						<tr>
							<td colspan="4">  </td>
							<td id="tot_items"> 0 </td>
							<td id="tot_qty"> 0 </td>
							<td id="subTotal"> 0  </td>
							<td width="30%" > <dd class="h4 b" id="total"> 0 </dd> </td>
						</tr>

						<tr>
							<td colspan="3"> </td>
							<td colspan="2"> <a href="{{url('pos/direct_barcode')}}" class="btn btn-default btn-error btn-lg btn-block btn_sale_cancel"><i class="fa fa-times-circle "></i> Cancel  </a> </td>
							<td colspan="2"> <a href="javascript:void(0)" onclick="finishSale()"  class="btn btn-default btn-error btn-lg btn-block btn_payment"><i class="fa fa-check"></i> Pay  </a> </td>
...
<div id="productsmodel" class="modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered  modal-xl">
	  ...
	  <div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel"> Choose Items </h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script type="text/javascript">
		...
		function calculate_items_qty() {
			...
			var total_items = $('.product_id').length;
			$("#tot_items").html(total_items);
	...
	function renderCart(){
		...
		$(cart).each(function(index, element){
			...
			<tr>\
				...
				<td> \
				<h6>'+element.barcode+'</h6>\
				</td>\
				<td>\ <input type="hidden" class="product_id" name="product_id[]" value="'+element.id+'">\
				<h6>'+element.name+'</h6>\
				...
				<td class="text-center"> \
					<div class="m-btn-group m-btn-group--pill btn-group mr-2" role="group" aria-label="...">\
																				\
					<input class="form-control qtyy" type="text" onchange="syncCart('+element.id+',\'quantity\',this)" name="quantity[]" min="1" step="1" value="'+element.quantity+'">\
																				</div>\
				</td>\
				<td> \
