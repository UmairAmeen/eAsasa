...
@endsection
@section('header')
<title>Return Sale Invoice Reporting</title>
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/buttons.dataTables.min.css')}}">
<div class="col-md-12 text-center">
	<h3>Return Sale Invoice Reporting</h3>
...
<div class="row showback">
	...
	<form method="GET" action="{{url('reports')}}/returnSale_invoice">
...
<table class="table datatable">
  ...
  <tbody>
    ...
    <?php $balance = 0 ?>
    @foreach($returnSale_invoice as $trans)
