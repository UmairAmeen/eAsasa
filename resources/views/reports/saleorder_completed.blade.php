...
@endsection
@section('header')
    <title>Completed Sale Order Reporting</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/buttons.dataTables.min.css') }}">
    <div class="col-md-12 text-center">
        <h3>Completed Sale Order Reporting</h3>
        <h4>Report from {{ date_format_app($from) }} to {{ date_format_app($to) }}</h4>
...
@section('content')
    <div class="row showback">
        ...
        <form method="GET" action="{{ url('reports') }}/completed_saleorders_details">

            <div class="col-md-6">
                <div class="form-group">
                    <label>From Completion Date</label>
                    <input type="date" class="form-control" name="from" value="{{ $from ?: date('Y-m-1') }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>To Completion Date</label>
        ...
        <div class="col-md-12">
            ...
            <h3>completed Sale Order Details</h3>
                ...
                <tbody>
                    ...
                    @foreach ($sale_orders as $trans)
                        ...
                        <tr>
                            ...
                            <td>{{ date('d-M-Y', strtotime($trans->completion_date)) }}</td>
